...
export class Ng2FlatpickrDirective {
   ...
   * Default:  null
   */
  @Output("onChange") public flatpickrOnChange: EventEmitter<FlatpickrEvent> =
    new EventEmitter();
   ...
   * Default:  null
   */
  @Output("onClose") public flatpickrOnClose: EventEmitter<FlatpickrEvent> =
    new EventEmitter();
   ...
   * Default:  null
   */
  @Output("onOpen") public flatpickrOnOpen: EventEmitter<FlatpickrEvent> =
    new EventEmitter();
   ...
   * Default:  null
   */
  @Output("onReady") public flatpickrOnReady: EventEmitter<FlatpickrEvent> =
    new EventEmitter();
  ...
  ngAfterViewInit() {
    ...
    this.flatpickr = <FlatpickrInstance>(
      nativeElement.flatpickr(this.flatpickrOptions)
    );
  }
